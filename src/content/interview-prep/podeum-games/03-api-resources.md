---
title: "Module 3: API Layer — 42 Services, Live Cricket Webhook & Fantasy Engine"
date: 2026-07-08
type: article
tags: [podeum, api, jax-rs, webhook, fantasy-sports, system-design, resilience4j, java]
related: [resume-deep-dive]
difficulty: Staff
estimated_reading_time: 35
description: "The central nervous system of Podeum Games. 42 services, 40+ REST resources, live cricket webhook from SportzInteractive, real-time fantasy score calculation with Resilience4j bulkhead, pod/quiz/prediction game engines, Quartz job scheduling, and service-to-service RSA auth."
---
