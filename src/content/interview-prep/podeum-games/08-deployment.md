---
title: "Module 8: Deployment & Infrastructure — AWS EKS, Docker, CI/CD"
date: 2026-07-08
type: article
tags: [podeum, aws, kubernetes, docker, devops, deployment, ci-cd]
related: [resume-deep-dive]
difficulty: Staff
estimated_reading_time: 20
description: "Complete deployment architecture for Podeum Games on AWS EKS. Multi-stage Docker builds, ECR container registry, Kubernetes Secrets for config, git-crypt encryption, CircleCI pipeline, and the case for EKS over Elastic Beanstalk or plain EC2."
---
