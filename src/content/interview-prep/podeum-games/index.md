---
title: "Podeum Games — Platform Architecture Deep Dive"
date: 2026-07-08
type: article
tags: [podeum, system-design, sports-gaming, java, aws, dropwizard, architecture]
related: [resume-deep-dive]
difficulty: Staff
estimated_reading_time: 20
description: "Comprehensive architecture deep-dive of the Podeum Games platform — a live sports fantasy gaming backend handling 10K DAU. Covers all 9 modules: MySQL/Hibernate economy, MongoDB document storage, live cricket webhook pipeline with Resilience4j bulkhead, Redis caching, PhonePe UPI payments, Firebase notifications, Dropwizard/Guice runtime, and AWS EKS deployment."
---
